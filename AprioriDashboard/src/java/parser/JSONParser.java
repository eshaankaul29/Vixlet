            ...
            for (int i = 0; i < mainArray.length(); i++) {
                try {
                    ...
                    if(eventObject.has("event")) {
                        ...
                        if(propertiesObject.has("mp_country_code") && propertiesObject.has("$region") && propertiesObject.has("$city")) {
                            String country = propertiesObject.getString("mp_country_code");
...
//                                    .append(types.indexOf(type)).append(LINE);
                        }
                    }
                } catch (Exception e) {
...
//                            if(i != candidates.length) {
                                area.append(names.get(index)).append(" ");
//                            } else {
